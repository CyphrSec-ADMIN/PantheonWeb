    ...
    <div className="relative bg-gray-900 rounded-4xl"> {/* Added rounded-4xl for border radius */}
      ...
      <Container className="relative">
        ...
        <div className="pb-24 pt-16 sm:pb-32 sm:pt-24 md:pb-48 md:pt-32">
          <h1 className="font-display text-balance text-6xl/[0.9] font-medium tracking-tight text-white sm:text-8xl/[0.8] md:text-9xl/[0.8] leading-[1.5]"> {/* Changed to leading-[1.5] for increased line spacing */}
           Secure Legacy Systems with AI
          </h1>
