  ...
  return (
    <div aria-hidden="true" className="relative size-full">
      ...
      <div className="absolute inset-0">
        <Marker src="/map/Servers.jpg" top={80} offset={-128} delay={0.1} />
        <Marker src="/map/Servers.jpg" top={96} offset={-128} delay={0.15} />
        <Marker src="/map/Servers.jpg" top={112} offset={-16} delay={0.2} />
        <Marker src="/map/Servers.jpg" top={144} offset={96} delay={0.3} />
        <Marker src="/map/Servers.jpg" top={160} offset={64} delay={0.4} />
        <Marker src="/map/Servers.jpg" top={192} offset={64} delay={0.6} />
        <Marker src="/map/Servers.jpg" top={208} offset={-32} delay={0.7} />
        <Marker src="/map/Servers.jpg" top={224} offset={-32} delay={0.8} />
      </div>
    </div>
  )
}
