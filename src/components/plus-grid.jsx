...
export function PlusGridRow({ className = '', children }) {
  return (
    ...
    >
      ...
      >
        <div className="absolute inset-x-0 top-0 border-t border-white/60"></div>
        <div className="absolute inset-x-0 top-2 border-t border-white/60"></div>
        <div className="absolute inset-x-0 bottom-0 hidden border-b border-white/60 group-last/row:block"></div>
        <div className="absolute inset-x-0 bottom-2 hidden border-b border-white/60 group-last/row:block"></div>
      </div>
      {children}
    </div>
  )
...
export function PlusGridIcon({ className = '', placement }) {
  ...
  return (
    <svg
      ...
      className={clsx(
        className,
        'absolute size-[15px] fill-white/60', // Changed to fill-white/60
        yClass,
        xClass,
      )}
    >
